          ...
          <div className="bottom-drawer" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-form">
              <div className="form-field">
                ...
                <input type="text" placeholder="Dit fulde navn" value={form.name} onChange={updateForm('name')} />
              </div>
              <div className="form-field">
                <label>Virksomhedsnavn *</label>
                <input type="text" placeholder="Navn på din virksomhed" value={form.company} onChange={updateForm('company')} />
              </div>
              <div className="form-field">
                <label>Telefonnummer</label>
                <input type="tel" placeholder="+45 00 00 00 00" value={form.phone} onChange={updateForm('phone')} />
              </div>
              <div className="form-field">
                <label>Hvad sælger du?</label>
                <input type="text" placeholder="Kort beskrivelse af dine varer" value={form.description} onChange={updateForm('description')} />
              </div>
